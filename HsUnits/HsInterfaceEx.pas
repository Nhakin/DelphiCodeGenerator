...
Type
  ...
  Public
    Property States : TInterfaceStates Read FStates;
...
Procedure RegisterInterface(Const AInterfaceName : String; Const AIID : TGUID); //OverLoad;
...
Type
  ...
  Protected
    Function  MyGet(Index: Integer) : IInterfaceIdentEx;
    Procedure MyPut(Index: Integer; Const Item: IInterfaceIdentEx);
    Function  MyAdd() : IInterfaceIdentEx;
    Function  MyIndexOf(Const AIID : TGUID) : Integer;

    Function  IInterfaceIdentsEx.Get = MyGet;
    Procedure IInterfaceIdentsEx.Put = MyPut;
    Function  IInterfaceIdentsEx.Add = MyAdd;
    Function  IInterfaceIdentsEx.IndexOf = MyIndexOf;

  Public
    Property Items[Index: Integer] : IInterfaceIdentEx Read MyGet Write MyPut; Default;
...
Function TInterfaceIdentsEx.MyGet(Index: Integer) : IInterfaceIdentEx;
Begin
  Result := InHerited Items[Index] As IInterfaceIdentEx;
End;

Procedure TInterfaceIdentsEx.MyPut(Index: Integer; Const Item: IInterfaceIdentEx);
Begin
  InHerited Items[Index] := Item As IInterfaceIdentEx;
End;

Function TInterfaceIdentsEx.MyAdd() : IInterfaceIdentEx;
Begin
  Result := TInterfaceIdentEx.Create();
  InHerited Add(Result As IInterfaceEx);
End;

Function TInterfaceIdentsEx.MyIndexOf(Const AIID : TGUID) : Integer;
Var X : Integer;
Begin
  Result := -1;
