...
//    Property Etched;
  ...
  Protected
    ...
    Property PreventCloseUp : Boolean  Read FPreventCloseUp Write FPreventCloseUp;
...
Begin
  If Not FPreventCloseUp Then
    HideDropDown(); //##Icitte StCriss
End;
